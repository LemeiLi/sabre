/* Header includes -----------------------------------------------------------*/
#include "infra/utils/ringbuffer.h"
#include <stdlib.h>
#include <string.h>
 ...
 * @note   This function copies at most @p len bytes from the @p in into
 ...
 * @note   This function copies at most @p len bytes from the FIFO into
 *         the @p out and returns the number of copied bytes.
 */
